model MAU
  parameter Modelica.Units.SI.VolumeFlowRate V_air_flowrate = 107.6 "Air Volume Flow Rate m3/s";
  parameter Modelica.Units.SI.Density rho_air = 1.204 "Air Density kg/m3";
  parameter Modelica.Units.SI.MassFlowRate m_air_flowrate = 129.55 "Air Mass Flow Rate kg/s" annotation(
    Placement(visible = false, transformation(extent = {{0, 0}, {0, 0}})));
  Buildings.Fluid.HeatExchangers.DryCoilCounterFlow coil_preheat(redeclare package Medium1 = Buildings.Media.Water "Water", redeclare package Medium2 = Buildings.Media.Air "Moist air", m1_flow_nominal = 154.14, m2_flow_nominal = m_air_flowrate, dp1_nominal = 20000, dp2_nominal = 73, UA_nominal = 215388) annotation(
    Placement(transformation(origin = {-244, -8}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Buildings.Fluid.HeatExchangers.WetCoilCounterFlow coil_precool(redeclare package Medium1 = Buildings.Media.Water "Water", redeclare package Medium2 = Buildings.Media.Air "Moist air", m1_flow_nominal = 182.81, m2_flow_nominal = m_air_flowrate, dp1_nominal = 100000, dp2_nominal = 178, UA_nominal = 600695) annotation(
    Placement(transformation(origin = {-106, -8}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Buildings.Fluid.HeatExchangers.WetCoilCounterFlow coil_postcool(redeclare package Medium1 = Buildings.Media.Water "Water", redeclare package Medium2 = Buildings.Media.Air "Moist air", m1_flow_nominal = 108.67, m2_flow_nominal = m_air_flowrate, dp1_nominal = 50000, dp2_nominal = 126, UA_nominal = 622695) annotation(
    Placement(transformation(origin = {238, -8}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Buildings.Fluid.HeatExchangers.DryCoilCounterFlow coil_postheat(redeclare package Medium1 = Buildings.Media.Water "Water", redeclare package Medium2 = Buildings.Media.Air "Moist air", m1_flow_nominal = 41.28, m2_flow_nominal = m_air_flowrate, dp1_nominal = 20000, dp2_nominal = 32, UA_nominal = 67472) annotation(
    Placement(transformation(origin = {406, -8}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Buildings.Fluid.FixedResistances.PressureDrop filter_amc(redeclare package Medium = Buildings.Media.Air "Moist air", m_flow_nominal = m_air_flowrate, dp_nominal = 20 + 20 + 180 + 109 + 16 + 494 + 600 + 115 + 191) annotation(
    Placement(transformation(origin = {-498, -2}, extent = {{-10, -10}, {10, 10}})));
  Buildings.Fluid.Movers.FlowControlled_m_flow fan(redeclare package Medium = Buildings.Media.Air "Moist air", m_flow_nominal = m_air_flowrate, dp_nominal = 2127, per(efficiency(V_flow = {0}, eta = {0.75}))) annotation(
  ...
  Modelica.Blocks.Sources.Constant setp_enth_postheat(k = 21.5 + 273.15) annotation(
    Placement(transformation(origin = {405, 32}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Sources.Constant m_flow_air(k = 129.55) annotation(
    Placement(transformation(origin = {535, 32}, extent = {{-10, -10}, {10, 10}})));
  Buildings.Fluid.Humidifiers.SprayAirWasher_X hum(redeclare package Medium = Buildings.Media.Air "Moist air", m_flow_nominal = m_air_flowrate, dp_nominal = 40) annotation(
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort sen_temp_humidifier(redeclare package Medium = Buildings.Media.Air "Moist air", m_flow_nominal = m_air_flowrate) annotation(
    Placement(transformation(origin = {152, -2}, extent = {{-10, -10}, {10, 10}})));
  Buildings.Fluid.Sensors.MassFractionTwoPort sen_hum_humidifier(redeclare package Medium = Buildings.Media.Air "Moist air", m_flow_nominal = m_air_flowrate) annotation(
  ...
  Modelica.Blocks.Sources.Constant setp_enth_winter(k = 40100) annotation(
  ...
  Buildings.Controls.Continuous.LimPID conPID_enth_precool(Ti = 60, controllerType = Modelica.Blocks.Types.SimpleController.P, k = 0.001, reverseActing = false) annotation(
    Placement(transformation(origin = {-26, 74}, extent = {{-10, -10}, {10, 10}})));
  ...
  Buildings.Fluid.HeatExchangers.DryCoilCounterFlow coil_antifreeze_heat(redeclare package Medium1 = Buildings.Media.Water "Water", redeclare package Medium2 = Buildings.Media.Air "Moist air", UA_nominal = 6698, dp1_nominal = 20000, dp2_nominal = 6, m1_flow_nominal = 3.93, m2_flow_nominal = m_air_flowrate) annotation(
...
equation
  ...
  connect(setp_enth_postheat.y, conPID_temp_postheat.u_s) annotation(
    Line(points = {{416, 32}, {424, 32}}, color = {0, 0, 127}));
  ...
  connect(coil_preheat.port_b2, sen_enth_preheat.port_a) annotation(
    Line(points = {{-234, -2}, {-224, -2}}, color = {0, 127, 255}));
  ...
  connect(hum.port_b, sen_temp_humidifier.port_a) annotation(
    Line(points = {{130, -2}, {142, -2}}, color = {0, 127, 255}));
  connect(sen_temp_humidifier.port_b, sen_hum_humidifier.port_a) annotation(
    Line(points = {{162, -2}, {172, -2}}, color = {0, 127, 255}));
  connect(sen_hum_humidifier.port_b, coil_postcool.port_a2) annotation(
    Line(points = {{192, -2}, {228, -2}}, color = {0, 127, 255}));
  ...
  connect(sen_temp_precool.port_b, sen_enth_precool.port_a) annotation(
    Line(points = {{-64, -2}, {-36, -2}}, color = {0, 127, 255}));
  connect(setp_humidity.y, hum.X_w) annotation(
    Line(points = {{99, 30}, {108, 30}, {108, 4}}, color = {0, 0, 127}));
  connect(setp_humidity.y, summer_cond_hum.u2) annotation(
    Line(points = {{99, 30}, {108, 30}, {108, 54}, {-304, 54}, {-304, 152}, {-290, 152}}, color = {0, 0, 127}));
  connect(sen_enth_precool.h_out, conPID_enth_precool.u_m) annotation(
    Line(points = {{-26, 9}, {-26, 62}}, color = {0, 0, 127}));
  connect(setp_enth_winter.y, conPID_enth_precool.u_s) annotation(
    Line(points = {{-45, 74}, {-38, 74}}, color = {0, 0, 127}));
  ...
  connect(conPID_enth_precool.y, product1.u2) annotation(
    Line(points = {{-15, 74}, {-8, 74}, {-8, 92}}, color = {0, 0, 127}));
  ...
  connect(sen_enth_precool.port_b, sen_hum_precool.port_a) annotation(
    Line(points = {{-16, -2}, {12, -2}}, color = {0, 127, 255}));
  connect(sen_hum_precool.port_b, sen_wetbulb_humer.port_a) annotation(
    Line(points = {{32, -2}, {78, -2}}, color = {0, 127, 255}));
  connect(sen_wetbulb_humer.port_b, hum.port_a) annotation(
    Line(points = {{98, -2}, {110, -2}}, color = {0, 127, 255}));
  connect(setp_humidity.y, conPID_hum_postcool.u_s) annotation(
    Line(points = {{99, 30}, {258, 30}}, color = {0, 0, 127}));
  ...
  connect(jun.port_2, coil_preheat.port_a1) annotation(
    Line(points = {{-234, -116}, {-234, -14}}, color = {0, 127, 255}));
  ...
  connect(coil_preheat.port_b1, val_preheat.port_a) annotation(
    Line(points = {{-254, -14}, {-254, -40}}, color = {0, 127, 255}));
  ...
  connect(sen_hum_antifreeze_heat.port_b, coil_preheat.port_a2) annotation(
    Line(points = {{-282, -2}, {-254, -2}}, color = {0, 127, 255}));
